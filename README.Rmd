...
```
`cmdlr` provides a preexisting utility for this, however. The `cmd_install_check`
...
`cmd_install_check` function, `cmdlr` also provides the `cmd_ui_file_exists` function
